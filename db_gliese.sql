...
-- Volcando datos para la tabla db_gliese.guest: ~43 rows (aproximadamente)
DELETE FROM `guest`;
...
-- Volcando datos para la tabla db_gliese.reservation: ~3 rows (aproximadamente)
...
-- Volcando datos para la tabla db_gliese.user: ~6 rows (aproximadamente)
DELETE FROM `user`;
INSERT INTO `user` (`id`, `id_role`, `id_document_type`, `first_name`, `last_name`, `document_number`, `address`, `telephone`, `email`, `user`, `password`, `image_url`, `status`, `active`) VALUES
	...
	(20, 5, 1, 'luis', 'leandro', '77777777', 'Lima', '211222222222', 'yijid11290@finghy.com', 'luis', '4d6a63774e54497a596a67775a5459784f4467304e4445784e57566d5954686a4d4441794f444e6d4f47493d', NULL, 1, 1);
...
-- Volcando datos para la tabla db_gliese.user_campus: ~16 rows (aproximadamente)
